...
Each skill is a **self-contained** folder that implements a deterministic browser automation workflow via the OpenClaw browser control service. Skills are designed to be used by AI agents, local runners, or any orchestration layer that speaks structured JSON.
